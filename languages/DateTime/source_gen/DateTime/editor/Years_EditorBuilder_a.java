...
import DateTime.behavior.Years__BehaviorDescriptor;
...
/*package*/ class Years_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Years_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private boolean nodeCondition_rshcez_a1a() {
    return ((double) Years__BehaviorDescriptor.AantalJaren_idbTj1CmnvAs.invoke(myNode) == 1);
  }
  private boolean nodeCondition_rshcez_a2a() {
