...
public final class Years__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xadd5042bc484352L, 0x832a07af4f0e5913L, 0x46db587183b322e6L, "DateTime.structure.Years");
  ...
  /*package*/ static double AantalJaren_idbTj1CmnvAs(@NotNull SNode __thisNode__) {
    if (isNotEmptyString(SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0xadd5042bc484352L, 0x832a07af4f0e5913L, 0x46db587183b322e6L, 0x46db587183b322eaL, "jaren")))) {
      return Double.valueOf(SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0xadd5042bc484352L, 0x832a07af4f0e5913L, 0x46db587183b322e6L, 0x46db587183b322eaL, "jaren")));
    }
    return 0;
  }
  /*package*/ static Duration geefDuur_id3JLo1nhiwEa(@NotNull SNode __thisNode__) {
    return ChronoUnit.YEARS.getDuration().multipliedBy((long) ((double) Years__BehaviorDescriptor.AantalJaren_idbTj1CmnvAs.invoke(__thisNode__)));
  }
  /*package*/ static void ZetDuur_id3CWQViUPQ1p(@NotNull SNode __thisNode__, Duration duration) {
    Long duur = duration.toDays();
    duur = duur / 365;
    SPropertyOperations.assign(__thisNode__, MetaAdapterFactory.getProperty(0xadd5042bc484352L, 0x832a07af4f0e5913L, 0x46db587183b322e6L, 0x46db587183b322eaL, "jaren"), duur.toString());
  }
  ...
  /*package*/ Years__BehaviorDescriptor() {
    super(REGISTRY);
  }
