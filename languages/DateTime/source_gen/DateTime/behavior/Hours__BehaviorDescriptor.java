...
public final class Hours__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xadd5042bc484352L, 0x832a07af4f0e5913L, 0x46db587183b2cba1L, "DateTime.structure.Hours");
  ...
  /*package*/ static double AantalUren_idbTj1CmnFSe(@NotNull SNode __thisNode__) {
    if (isNotEmptyString(SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0xadd5042bc484352L, 0x832a07af4f0e5913L, 0x46db587183b2cba1L, 0x46db587183b2cba2L, "hours")))) {
      return Double.valueOf(SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0xadd5042bc484352L, 0x832a07af4f0e5913L, 0x46db587183b2cba1L, 0x46db587183b2cba2L, "hours")));
    }
    return 0;
  }
  /*package*/ static Duration geefDuur_id3JLo1nhiwEa(@NotNull SNode __thisNode__) {
    return ChronoUnit.HOURS.getDuration().multipliedBy((long) ((double) Hours__BehaviorDescriptor.AantalUren_idbTj1CmnFSe.invoke(__thisNode__)));
  }
  ...
  /*package*/ Hours__BehaviorDescriptor() {
    super(REGISTRY);
  }
