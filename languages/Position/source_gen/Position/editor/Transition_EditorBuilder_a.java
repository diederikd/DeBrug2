...
/*package*/ class Transition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_jj4qz_a() {
    ...
    editorCell.addEditorCell(createProperty_jj4qz_c0());
    editorCell.addEditorCell(createConstant_jj4qz_d0());
    editorCell.addEditorCell(createRefCell_jj4qz_e0());
    return editorCell;
  }
  ...
  private EditorCell createProperty_jj4qz_c0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = MetaAdapterFactory.getProperty(0x1172cef30f894114L, 0xad0ef59cef2bbaa3L, 0x78836771e8cfbf8dL, 0x78836771e8cfbfdeL, "type");
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private EditorCell createConstant_jj4qz_d0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "de toestand");
  ...
  private EditorCell createRefCell_jj4qz_e0() {
    final SReferenceLink referenceLink = MetaAdapterFactory.getReferenceLink(0x1172cef30f894114L, 0xad0ef59cef2bbaa3L, 0x78836771e8cfbf8dL, 0x78836771e8cfbf94L, "state");
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new Transition_EditorBuilder_a.Inline_Builder_jj4qz_a4a(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, "state");
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
  ...
  /*package*/ static class Inline_Builder_jj4qz_a4a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;
    private SNode myReferencingNode;

    /*package*/ Inline_Builder_jj4qz_a4a(@NotNull EditorContext context, SNode referencingNode, @NotNull SNode node) {
      super(context);
      myReferencingNode = referencingNode;
      myNode = node;
    }
    ...
    /*package*/ EditorCell createCell() {
      return createProperty_jj4qz_a0e0();
    }
    ...
    private EditorCell createProperty_jj4qz_a0e0() {
      getCellFactory().pushCellContext();
      try {
        final SProperty property = MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name");
        getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
