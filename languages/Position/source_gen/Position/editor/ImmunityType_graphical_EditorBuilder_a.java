...
/*package*/ class ImmunityType_graphical_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ImmunityType_graphical_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  /*package*/ EditorCell createCell() {
    return createDiagramNode_hjj9e1_a_0();
  }

  private EditorCell createDiagramNode_hjj9e1_a(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        EditorCell contentCell = createCollection_hjj9e1_a0();
        ...
        editorCell.value.setCellId("DiagramNode_hjj9e1_a");
  ...
  private EditorCell createDiagramNode_hjj9e1_a_0() {
    return createDiagramNode_hjj9e1_a(getEditorContext(), myNode);
  }
  private EditorCell createCollection_hjj9e1_a0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_hjj9e1_a0");
    editorCell.addEditorCell(createProperty_hjj9e1_a0a());
    return editorCell;
  }
  private EditorCell createProperty_hjj9e1_a0a() {
