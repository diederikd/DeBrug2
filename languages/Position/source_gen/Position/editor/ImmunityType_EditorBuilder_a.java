...
/*package*/ class ImmunityType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_xedg3_a();
  }

  private EditorCell createCollection_xedg3_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_xedg3_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createComponent_xedg3_a0());
    if (nodeCondition_xedg3_a1a()) {
      editorCell.addEditorCell(createConstant_xedg3_b0());
    }
    editorCell.addEditorCell(createRefNode_xedg3_c0());
    editorCell.addEditorCell(createCollection_xedg3_d0());
    editorCell.addEditorCell(createConstant_xedg3_e0());
    return editorCell;
  }
  ...
  private EditorCell createComponent_xedg3_a0() {
  ...
  private EditorCell createConstant_xedg3_b0() {
  ...
  private EditorCell createRefNode_xedg3_c0() {
  ...
  private EditorCell createCollection_xedg3_d0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_xedg3_d0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createConstant_xedg3_a3a());
    editorCell.addEditorCell(createConstant_xedg3_b3a());
    editorCell.addEditorCell(createRefNodeList_xedg3_c3a());
    editorCell.addEditorCell(createRefNode_xedg3_d3a());
    return editorCell;
  }
  private EditorCell createConstant_xedg3_a3a() {
  ...
  private EditorCell createConstant_xedg3_b3a() {
  ...
  private EditorCell createRefNodeList_xedg3_c3a() {
    AbstractCellListHandler handler = new ImmunityType_EditorBuilder_a.rolesListHandler_xedg3_c3a(myNode, "roles", getEditorContext());
  ...
  private static class rolesListHandler_xedg3_c3a extends RefNodeListHandler {
    ...
    public rolesListHandler_xedg3_c3a(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createNodeCell(SNode elementNode) {
      ...
      elementCell.setAction(CellActionType.SELECT_NEXT, new CellAction_CreateChildRangeSelection(elementNode, new ImmunityType_EditorBuilder_a.RangeSelectionFilter_xedg3_c3a(), "empty_roles", getEditorContext(), true));
      elementCell.setAction(CellActionType.SELECT_PREVIOUS, new CellAction_CreateChildRangeSelection(elementNode, new ImmunityType_EditorBuilder_a.RangeSelectionFilter_xedg3_c3a(), "empty_roles", getEditorContext(), false));
      return elementCell;
    }
  ...
  private EditorCell createRefNode_xedg3_d3a() {
  ...
  private EditorCell createConstant_xedg3_e0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
