...
/*package*/ class HeaderOfStateType_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_qh6zoz_a() {
    ...
    editorCell.addEditorCell(createConstant_qh6zoz_d0());
    editorCell.addEditorCell(createProperty_qh6zoz_e0());
    return editorCell;
  }
  ...
  private EditorCell createConstant_qh6zoz_d0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_qh6zoz_d0");
    Style style = new StyleImpl();
    new PlainStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createProperty_qh6zoz_e0() {
    getCellFactory().pushCellContext();
    try {
