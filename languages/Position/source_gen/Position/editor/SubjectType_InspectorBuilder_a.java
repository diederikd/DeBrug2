...
/*package*/ class SubjectType_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_9o4i4j_a_0() {
    ...
    editorCell.addEditorCell(createConstant_9o4i4j_b0_0());
    editorCell.addEditorCell(createRefNode_9o4i4j_c0());
    editorCell.addEditorCell(createConstant_9o4i4j_d0_0());
    editorCell.addEditorCell(createConstant_9o4i4j_e0());
    editorCell.addEditorCell(createProperty_9o4i4j_f0());
    editorCell.addEditorCell(createConstant_9o4i4j_g0());
    editorCell.addEditorCell(createConstant_9o4i4j_h0());
    editorCell.addEditorCell(createConstant_9o4i4j_i0());
    editorCell.addEditorCell(createRefNodeList_9o4i4j_j0());
    editorCell.addEditorCell(createConstant_9o4i4j_k0());
    editorCell.addEditorCell(createConstant_9o4i4j_l0());
    editorCell.addEditorCell(createConstant_9o4i4j_m0());
    editorCell.addEditorCell(createRefNodeList_9o4i4j_n0());
    return editorCell;
  }
  ...
  private EditorCell createConstant_9o4i4j_b0_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_9o4i4j_b0_0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_9o4i4j_c0() {
  ...
  private EditorCell createProperty_9o4i4j_f0() {
    getCellFactory().pushCellContext();
    try {
  ...
  private EditorCell createConstant_9o4i4j_g0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_9o4i4j_g0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNodeList_9o4i4j_j0() {
    AbstractCellListHandler handler = new SubjectType_InspectorBuilder_a.specialisatiesListHandler_9o4i4j_j0(myNode, "specialisaties", getEditorContext());
  ...
  private static class specialisatiesListHandler_9o4i4j_j0 extends RefNodeListHandler {
    ...
    public specialisatiesListHandler_9o4i4j_j0(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createConstant_9o4i4j_k0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_9o4i4j_k0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_9o4i4j_l0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "geidentificeerd door");
    editorCell.setCellId("Constant_9o4i4j_l0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_9o4i4j_m0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_9o4i4j_m0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_9o4i4j_n0() {
    AbstractCellListHandler handler = new SubjectType_InspectorBuilder_a.identifiedByListHandler_9o4i4j_n0(myNode, "identifiedBy", getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class identifiedByListHandler_9o4i4j_n0 extends RefNodeListHandler {
    ...
    public identifiedByListHandler_9o4i4j_n0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
      myNode = ownerNode;
    }
