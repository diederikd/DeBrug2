...
/*package*/ class AbstractEventType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new AbstractEventType_EditorBuilder_a.rolesListHandler_qrmbbh_a5a0a5a(myNode, getEditorContext());
  ...
  private static class rolesListHandler_qrmbbh_a5a0a5a extends RefNodeListHandler {
    ...
    public rolesListHandler_qrmbbh_a5a0a5a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new AbstractEventType_EditorBuilder_a.methodsListHandler_qrmbbh_a2b0a5a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class methodsListHandler_qrmbbh_a2b0a5a extends RefNodeListHandler {
    ...
    public methodsListHandler_qrmbbh_a2b0a5a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
  ...
  private EditorCell createRefNodeList_2() {
    AbstractCellListHandler handler = new AbstractEventType_EditorBuilder_a.transitionsListHandler_qrmbbh_a2c0a5a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class transitionsListHandler_qrmbbh_a2c0a5a extends RefNodeListHandler {
    ...
    public transitionsListHandler_qrmbbh_a2c0a5a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
