...
/*package*/ class EventType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_koyvu4_a() {
    ...
    editorCell.addEditorCell(createProperty_koyvu4_c0());
    if (nodeCondition_koyvu4_a3a()) {
      editorCell.addEditorCell(createConstant_koyvu4_d0());
    }
    editorCell.addEditorCell(createRefNode_koyvu4_e0());
    editorCell.addEditorCell(createCollection_koyvu4_f0());
    editorCell.addEditorCell(createConstant_koyvu4_g0());
    return editorCell;
  }
  ...
  private EditorCell createProperty_koyvu4_c0() {
  ...
  private EditorCell createRefNode_koyvu4_e0() {
  ...
  private EditorCell createCollection_koyvu4_f0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createCollection_koyvu4_a5a());
    return editorCell;
  }
  private EditorCell createCollection_koyvu4_a5a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createCollection_koyvu4_a0f0());
    return editorCell;
  }
  private EditorCell createCollection_koyvu4_a0f0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createCollection_koyvu4_a0a5a());
    editorCell.addEditorCell(createCollection_koyvu4_b0a5a());
    return editorCell;
  }
  private EditorCell createCollection_koyvu4_a0a5a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_koyvu4_a0a5a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createConstant_koyvu4_a0a0f0());
    editorCell.addEditorCell(createConstant_koyvu4_b0a0f0());
    editorCell.addEditorCell(createCollection_koyvu4_c0a0f0());
    return editorCell;
  }
  private EditorCell createConstant_koyvu4_a0a0f0() {
  ...
  private EditorCell createConstant_koyvu4_b0a0f0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
  ...
  private EditorCell createCollection_koyvu4_c0a0f0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createRefNodeList_koyvu4_a2a0a5a());
    editorCell.addEditorCell(createConstant_koyvu4_b2a0a5a());
    editorCell.addEditorCell(createConstant_koyvu4_c2a0a5a());
    editorCell.addEditorCell(createProperty_koyvu4_d2a0a5a());
    return editorCell;
  }
  private EditorCell createRefNodeList_koyvu4_a2a0a5a() {
    AbstractCellListHandler handler = new EventType_EditorBuilder_a.rolesListHandler_koyvu4_a2a0a5a(myNode, "roles", getEditorContext());
  ...
  private static class rolesListHandler_koyvu4_a2a0a5a extends RefNodeListHandler {
    ...
    public rolesListHandler_koyvu4_a2a0a5a(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createNodeCell(SNode elementNode) {
      ...
      elementCell.setAction(CellActionType.SELECT_NEXT, new CellAction_CreateChildRangeSelection(elementNode, new EventType_EditorBuilder_a.RangeSelectionFilter_koyvu4_a2a0a5a(), "empty_roles", getEditorContext(), true));
      elementCell.setAction(CellActionType.SELECT_PREVIOUS, new CellAction_CreateChildRangeSelection(elementNode, new EventType_EditorBuilder_a.RangeSelectionFilter_koyvu4_a2a0a5a(), "empty_roles", getEditorContext(), false));
      return elementCell;
    }
  ...
  private EditorCell createConstant_koyvu4_b2a0a5a() {
  ...
  private EditorCell createConstant_koyvu4_c2a0a5a() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
  ...
  private EditorCell createProperty_koyvu4_d2a0a5a() {
    getCellFactory().pushCellContext();
    try {
  ...
  private EditorCell createCollection_koyvu4_b0a5a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    ...
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createConstant_koyvu4_a1a0f0());
    editorCell.addEditorCell(createConstant_koyvu4_b1a0f0());
    editorCell.addEditorCell(createCollection_koyvu4_c1a0f0());
    return editorCell;
  }
  private EditorCell createConstant_koyvu4_a1a0f0() {
  ...
  private EditorCell createConstant_koyvu4_b1a0f0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_koyvu4_b1a0f0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createCollection_koyvu4_c1a0f0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    ...
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createRefNodeList_koyvu4_a2b0a5a());
    return editorCell;
  }
  private EditorCell createRefNodeList_koyvu4_a2b0a5a() {
    AbstractCellListHandler handler = new EventType_EditorBuilder_a.transitionsListHandler_koyvu4_a2b0a5a(myNode, "transitions", getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class transitionsListHandler_koyvu4_a2b0a5a extends RefNodeListHandler {
    ...
    public transitionsListHandler_koyvu4_a2b0a5a(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_koyvu4_g0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
