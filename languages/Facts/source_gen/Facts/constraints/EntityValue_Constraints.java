...
public class EntityValue_Constraints extends BaseConstraintsDescriptor {
  private static final Logger LOG = LogManager.getLogger(EntityValue_Constraints.class);
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            {
              ...
              LoggingRuntime.logMsgView(Level.INFO, "" + _context.getReferenceNode() + _context.getContextNode(), EntityValue_Constraints.class, null, null);
              return ListScope.forNamedElements(SLinkOperations.getChildren(ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(SNodeOperations.getParent(_context.getContextNode()), MetaAdapterFactory.getConcept(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0xe475eafb2f49215L, "Facts.structure.FactBase"), false, false), MetaAdapterFactory.getContainmentLink(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0xe475eafb2f49215L, 0xab4c0de8e6a1287L, "entityTables"))).where(new IWhereFilter<SNode>() {
