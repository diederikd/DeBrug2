...
public final class PercentageValue__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0x435274beed27746L, "Facts.structure.PercentageValue");
  ...
  /*package*/ static String getValueString_id3MspsB814vW(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0x435274beed27746L, 0x435274beed27747L, "value")), MetaAdapterFactory.getProperty(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0x435274beed27742L, 0x435274beed27743L, "value")).toString() + " %";
  }

  /*package*/ PercentageValue__BehaviorDescriptor() {
    super(REGISTRY);
  }
