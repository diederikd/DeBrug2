...
public final class Variable__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull final SNode __thisNode__, SAbstractConcept kind, SNode child) {
    ...
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), MetaAdapterFactory.getConcept(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0xab4c0de8e6a127fL, "Facts.structure.Entity")) && ScopeUtils.comeFrom(MetaAdapterFactory.getContainmentLink(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0xe475eafb2f47cacL, 0xe475eafb30d95edL, "value"), __thisNode__, child) && (SNodeOperations.getContainingRoot(__thisNode__) != null)) {
      return ListScope.forNamedElements(SLinkOperations.collectMany(SNodeOperations.getNodeDescendants(SNodeOperations.getContainingRoot(__thisNode__), MetaAdapterFactory.getConcept(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0xab4c0de8e6a1380L, "Facts.structure.EntityTable"), false, new SAbstractConcept[]{}), MetaAdapterFactory.getContainmentLink(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0xab4c0de8e6a1380L, 0xab4c0de8e6a1383L, "entities")));
    }
