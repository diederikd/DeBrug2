...
/*package*/ class specialisaties_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_3zlvk0_a();
  }

  private EditorCell createCollection_3zlvk0_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_3zlvk0_a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createConstant_3zlvk0_a0());
    editorCell.addEditorCell(createConstant_3zlvk0_b0());
    editorCell.addEditorCell(createRefNodeList_3zlvk0_c0());
    editorCell.addEditorCell(createConstant_3zlvk0_d0());
    return editorCell;
  }
  private EditorCell createConstant_3zlvk0_a0() {
  ...
  private EditorCell createConstant_3zlvk0_b0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_3zlvk0_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_3zlvk0_c0() {
    AbstractCellListHandler handler = new specialisaties_ComponentBuilder_a.specialisatiesListHandler_3zlvk0_c0(myNode, "specialisaties", getEditorContext());
  ...
  private static class specialisatiesListHandler_3zlvk0_c0 extends RefNodeListHandler {
    ...
    public specialisatiesListHandler_3zlvk0_c0(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createConstant_3zlvk0_d0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
