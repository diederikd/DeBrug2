...
/*package*/ class EntityValue_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class QueryListHandler_p4o3j3_a0a extends QueryListHandler {
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        {
          final EntityValue_EditorBuilder_a.Inline_Builder0 provider = new EntityValue_EditorBuilder_a.Inline_Builder0(context, myNode, node);
  ...
  private EditorCell createRefCell_0() {
      ...
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new EntityValue_EditorBuilder_a.Inline_Builder1(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, MetaAdapterFactory.getReferenceLink(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0xab4c0de8e6a1284L, 0xab4c0de8e6a1285L, "value"));
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(MetaAdapterFactory.getReferenceLink(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0xab4c0de8e6a1284L, 0xab4c0de8e6a1285L, "value"));
    }
    if (true) {
