...
/*package*/ class EntityValue_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_p4o3j3_a1a() {
    final SReferenceLink referenceLink = MetaAdapterFactory.getReferenceLink(0x2aacdfbf487f43acL, 0xa43119468403f2c5L, 0xab4c0de8e6a1284L, 0xab4c0de8e6a1285L, "value");
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new EntityValue_EditorBuilder_a.Inline_Builder_p4o3j3_a0b0(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, "value");
