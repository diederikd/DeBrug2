...
/*package*/ class EntityTypeInRole_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_p05uze_a() {
    ...
    editorCell.addEditorCell(createComponent_p05uze_a0());
  ...
  private EditorCell createComponent_p05uze_a0() {
      ...
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new EntityTypeInRole_EditorBuilder_a.Inline_Builder_p05uze_a3a(getEditorContext(), getNode(), targetNode).createCell();
          }
