...
/*package*/ class FactType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new FactType_EditorBuilder_a.rolesListHandler_5mto8z_c3a(myNode, getEditorContext());
  ...
  private static class rolesListHandler_5mto8z_c3a extends RefNodeListHandler {
    ...
    public rolesListHandler_5mto8z_c3a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new FactType_EditorBuilder_a.wordingsListHandler_5mto8z_c4a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class wordingsListHandler_5mto8z_c4a extends RefNodeListHandler {
    ...
    public wordingsListHandler_5mto8z_c4a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
  ...
  private EditorCell createRefNodeList_2() {
    AbstractCellListHandler handler = new FactType_EditorBuilder_a.identifiedByListHandler_5mto8z_c5a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class identifiedByListHandler_5mto8z_c5a extends RefNodeListHandler {
    ...
    public identifiedByListHandler_5mto8z_c5a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
