...
/*package*/ class FactValue_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_2f9rhf_a();
  }

  private EditorCell createCollection_2f9rhf_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_2f9rhf_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createCollection_2f9rhf_a0());
    editorCell.addEditorCell(createCollection_2f9rhf_b0());
    return editorCell;
  }
  private EditorCell createCollection_2f9rhf_a0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    ...
    editorCell.addEditorCell(createQueryList_2f9rhf_a0a_0());
    return editorCell;
  }
  private EditorCell createQueryList_2f9rhf_a0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createQueryList_2f9rhf_a0a_0() {
    return createQueryList_2f9rhf_a0a(getEditorContext(), myNode);
  }
  private static class QueryListHandler_2f9rhf_a0a extends QueryListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return createEmpty_2f9rhf_a0a0();
    }
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      EditorCell cell;
      {
        final FactValue_EditorBuilder_a.Inline_Builder_2f9rhf_a0a0 provider = new FactValue_EditorBuilder_a.Inline_Builder_2f9rhf_a0a0(context, myNode, node);
    ...
    private EditorCell createEmpty_2f9rhf_a0a0() {
  ...
  /*package*/ static class Inline_Builder_2f9rhf_a0a0 extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;
    private SNode myReferencingNode;

    /*package*/ Inline_Builder_2f9rhf_a0a0(@NotNull EditorContext context, SNode referencingNode, @NotNull SNode node) {
      super(context);
    ...
    /*package*/ EditorCell createCell() {
      return createReadOnlyModelAccessor_2f9rhf_a0a0a();
    }
    ...
    private EditorCell createReadOnlyModelAccessor_2f9rhf_a0a0a() {
  ...
  private EditorCell createCollection_2f9rhf_b0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_2f9rhf_b0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createRefCell_2f9rhf_a1a());
    return editorCell;
  }
  private EditorCell createRefCell_2f9rhf_a1a() {
      ...
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new FactValue_EditorBuilder_a.Inline_Builder_2f9rhf_a0b0(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, "value");
  ...
  /*package*/ static class Inline_Builder_2f9rhf_a0b0 extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;
    private SNode myReferencingNode;

    /*package*/ Inline_Builder_2f9rhf_a0b0(@NotNull EditorContext context, SNode referencingNode, @NotNull SNode node) {
      super(context);
      myReferencingNode = referencingNode;
      myNode = node;
    }
    ...
    /*package*/ EditorCell createCell() {
      return createProperty_2f9rhf_a0a1a();
    }
    ...
    private EditorCell createProperty_2f9rhf_a0a1a() {
